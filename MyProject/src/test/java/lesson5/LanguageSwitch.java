...
public class LanguageSwitch extends AbstractTest{
    ...
    void test() throws InterruptedException {
        ...
        WebElement languageDeutsch = getDriver().findElement(By.xpath(".//a[contains(text(), 'English (en)')]"));
        languageDeutsch.click();

        Assertions.assertDoesNotThrow(() -> getDriver().findElement(By.xpath(".//span[contains(text(), 'English')]")));
    }
